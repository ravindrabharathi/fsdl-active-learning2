...
from active_learning.sampling import pt_sampler # for active learning sampling 
...
def main():
    ...
    while (unlabelled_data_size>1000):
        ...
        if sampling_method=='random':
            ...
            new_indices= pt_sampler.get_random_samples(pool_size=unlabelled_data_size,sample_size=sample_size)
            '''
            ...
            new_indices=pt_sampler.get_least_confidence_samples(predictions,sample_size=sample_size)
            ...
            #pass predictions and sample size as args
            new_indices=pt_sampler.get_top2_confidence_margin_samples(predictions,sample_size=sample_size) 
            '''
            ...
            new_indices=pt_sampler.get_top2_confidence_ratio_samples(predictions,sample_size=sample_size) 

        elif sampling_method=='entropy':
                       
            new_indices=pt_sampler.get_entropy_samples(predictions,sample_size=sample_size)     
